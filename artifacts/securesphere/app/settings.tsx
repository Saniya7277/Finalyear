...
export default function Settings() {
  ...
  const SECURITY_SETTINGS = [
    ...
    },
    {
      ...
      subtitle: "Recommended — adds 8 pts to score",
      icon: "shield-checkmark",
      color: "#00E676",
    },
    {
      key: "autoEncrypt",
      label: "Auto-Encrypt Uploads",
      subtitle: "AES-256 applied on upload",
      icon: "lock-closed",
      color: "#0066FF",
    },
    {
      ...
      subtitle: "Locks after 5 minutes idle",
      icon: "lock-open",
      color: "#FF8C00",
    },
    {
  ...
  const PRIVACY_SETTINGS = [
    {
      ...
      subtitle: "Searches never leave your device",
      icon: "search",
      color: "#00D4FF",
    },
    {
      ...
      subtitle: "Alerts for threats and access",
      icon: "notifications",
      color: "#FF8C00",
    },
    {
      ...
      subtitle: "Help improve SecureSphere",
      icon: "analytics",
      color: "#7A9BB5",
    },
  ] as const;
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        <GlassCard noPadding style={{ overflow: "hidden" }}>
          <ToggleRow
            label="Dark Mode"
            subtitle="Cybersecurity aesthetic"
            value={darkMode}
