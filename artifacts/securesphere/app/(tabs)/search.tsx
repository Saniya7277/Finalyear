    ...
    query.length > 0
      ? DUMMY_FILES.filter((f) => {
          ...
          if (activeFilter === "Encrypted") {
            return matchSearch && f.encrypted;
          }

          if (activeFilter === "Shared") {
            return matchSearch && f.shared;
          }

          if (activeFilter === "My Files") {
            return matchSearch && f.ownerId === "current";
          }
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={[styles.header, { paddingTop: topPad + 16 }]}>
        ...
        >
          ...
          <Text style={[styles.encryptBadgeText, { color: colors.success }]}>
            Encrypted
          </Text>
        </View>
      </View>
      ...
      <View
        style={[
          styles.searchBar,
          {
            ...
            borderColor:
              query.length > 0 ? `${colors.primary}60` : colors.border,
          },
        ]}
      >
        <Ionicons
          name="search"
          size={20}
          color={query.length > 0 ? colors.primary : colors.mutedForeground}
        />
        ...
        ListEmptyComponent={
          query.length > 0 ? (
            <View style={styles.empty}>
              ...
              >
                No encrypted files match "{query}"
              </Text>
            </View>
          ) : null
        }
